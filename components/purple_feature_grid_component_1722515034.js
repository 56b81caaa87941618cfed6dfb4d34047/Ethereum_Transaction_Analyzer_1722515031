    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Ethereum Transaction Analysis</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Gain deep insights into new Ethereum transactions as they occur. Our app analyzes transaction data in real-time, providing you with valuable information about senders, recipients, amounts, and more.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Keep a close eye on smart contract activity. Our app monitors Ethereum smart contracts and alerts you whenever a new transaction interacts with them, helping you stay informed about key events.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Address Tracking</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Track specific Ethereum addresses of interest. Set up watchlists to receive notifications whenever transactions involve your monitored addresses, ensuring you never miss important activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Transaction Visualization</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Visualize Ethereum transaction data in intuitive and interactive ways. Our app provides clear graphical representations of transaction flows, making it easy to spot patterns and anomalies.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Configure custom alerts based on your specific needs. Set thresholds for transaction amounts, contract events, or any other criteria, and receive timely notifications when conditions are met.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
