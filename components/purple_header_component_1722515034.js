...
Vue.component("purple_header_component_1722515034", {
    template: `
    <header class="w-full z-30" id="header-section-container">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 bg-transparent backdrop-filter backdrop-blur-lg bg-opacity-30 border border-pink-200 border-opacity-20 rounded-lg shadow-lg">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Features-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Features.html">Features</a></li>
                        <li><a id="Pricing-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Pricing.html">Pricing</a></li>
                        <li><a id="Analytics-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Analytics.html">Analytics</a></li>
                        <li><a id="Analyze Ethereum Txns-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Analyze Ethereum Txns.html">Analyze Ethereum Txns</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-pink-200 border-opacity-20 rounded-lg px-4 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-30 backdrop-filter backdrop-blur-lg">
                            <li><a id="mobile-Home-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Home.html">Home</a></li>
                            <li><a id="mobile-Features-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Features.html">Features</a></li>
                            <li><a id="mobile-Pricing-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Pricing.html">Pricing</a></li>
                            <li><a id="mobile-Analytics-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Analytics.html">Analytics</a></li>
                            <li><a id="mobile-Analyze Ethereum Txns-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Analyze Ethereum Txns.html">Analyze Ethereum Txns</a></li>
                        </ul>
                    </nav>
